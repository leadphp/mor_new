          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Algorithm's Feature</h3>
              </div>            


              <form method="POST" action="{{ url('admin/features/add')}}" class="form-horizontal" enctype="multipart/form-data" role="form">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Title :</label>
                      <div class="col-sm-12">
                        <input type="text" class="span form-control" placeholder="Enter algorithm feature title" name="title" value="{{old('title')}}"> @if($errors->has('title'))
