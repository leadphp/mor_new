...
$auth = \Auth::user();
if(!empty($auth)){
    $ques = \App\question_survey::where('user_id',\Auth::user()->id)->where('question_id','2')->get();
    if(count($ques)){
    $ques2 = $ques;
	}
}
		...
		<div class="q3 chat-container d-f f-d-c a-i-f-s">
			...
			<div class="chat-buttons ques2">
				<ul class="question2-ul my_question <?php if(isset($ques2)){ echo'click-color-change'; }else{ } ?>">
			  	<li>
			  		<input id="input21" type="radio" name="que2" value="Yes" <?php if(isset($ques2)){ if($ques2[0]->meta_value == "Yes"){ echo "checked=checked"; } else{ } } ?> >
					...
					<div class="form-inline multiple-dropdown up-fo" id="dlt_2_<?php echo $ss; ?>">
						...
						<div class="second">
							<div class="form-group">
						      	...
						      	<input type="text" id="property-value<?php echo $ss; ?>" class="form-control" name="property_value[]" placeholder="2,000,000" value="<?php if(isset($ques2)){ echo $property_value[$count]; } ?>"  onkeyup="this.value=addCommas(this.value);"/>
							  	<img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							  	<div class="errorquestion error-property-value<?php echo $ss; ?>" style="display:none;">Value should be more than or equal to 10000</div>
							</div>
							<div class="form-group with_mortgage<?php echo $ss; ?>"   
								...
								>
						      	...
						      	<input type="text" id="monthly-income<?php echo $ss; ?>" class="form-control" name="monthly_income[]" placeholder="2,000,000" value="<?php if(isset($ques2)){ echo $monthly_income[$count]; } ?>" onkeyup="this.value=addCommas(this.value);"/>
							  	<img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							...
							<div class="form-group">
						      ...
						      <input type="text" id="property-value-2<?php echo $ss; ?>" class="form-control" name="property_value_2[]" placeholder="1,000,000" value="<?php if(isset($ques2)){ echo $property_value_2[$count]; } ?>" onkeyup="this.value=addCommas(this.value);"/>
							  <img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							</div>
						</div>
						<div class="third">
							<div class="form-group empty"></div>
							<div class="form-group with_mortgage<?php echo $ss; ?> " style="display:none;">
							  <label for="mortgage-balance<?php echo $ss; ?>">החזר חודשי של המשכנתא:</label>
						      <input type="text" id="mortgage-balance<?php echo $ss; ?>" class="form-control" name="mortgage_balance[]" placeholder="1000,000" value="<?php if(isset($ques2)){ echo $mortgage_balance[$count]; } ?>" onkeyup="this.value=addCommas(this.value);"/>
							  <img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							</div>
							<div class="form-group with_mortgage<?php echo $ss; ?>" style="display:none;">
					...
					<div class="form-inline multiple-dropdown up-fo" id="dlt_2_1">
						...
						<div class="second">
							<div class="form-group">
						      	...
						      	<input type="text" id="property-value1" class="form-control" name="property_value[]" placeholder="2,000,000" value="10,000" onkeyup="this.value=addCommas(this.value);"/>
							  	<img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							  	<div class="errorquestion error-property-value1" style="display:none;">Value should be more than or equal to 10000</div>
							</div>
							<div class="form-group with_mortgage1" style="display:none;">
							  	<label for="monthly-income">יתרת המשכנתא:</label>
						      	<input type="text" id="monthly-income1" class="form-control" name="monthly_income[]" placeholder="2,000,000" value="1,000" onkeyup="this.value=addCommas(this.value);"/>
							  	<img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							...
							<div class="form-group">
						      ...
						      <input type="text" id="property-value-2" class="form-control" name="property_value_2[]" placeholder="1,000,000" value="1,000" onkeyup="this.value=addCommas(this.value);"/>
							  <img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							</div>
						</div>
						<div class="third">
							...
							<div class="form-group with_mortgage1" style="display:none;">
						      ...
						      <input type="text" id="mortgage-balance1" class="form-control" name="mortgage_balance[]" placeholder="1000,000" value="2,000" onkeyup="this.value=addCommas(this.value);"/>
							  <img src="images/placeholder-icon.png" alt="" class="placeholder-icon"/>
							</div>
							<div class="form-group with_mortgage1" style="display:none;">
								<label for="monthly-income-rent">באיזה בנק המשכנתא:</label>
...
<script>
	...
	$('body').on('click','.dlt_btn_2', function() {
		...
		$('.repeated_div_second_question .form-inline .first a:first').attr('data-id','dlt_2_1');
		$('.repeated_div_second_question .form-inline .first a:last').attr('data-id','dlt_2_2');
	});
...
//-----------Validation purpose--------------------------------
 ...
 <!-- <div id="loadQuestionThree" class="loading-trans">
   
	@php
         $no = \App\question_survey::where('user_id',\Auth::user()->id)->latest()->first();   
 	@endphp

     @if(!empty($no) && $no->question_id >= 3)
