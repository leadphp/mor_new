        ...
        <div class="container-fluid d-f">
            ...
            <div class="all-questions-wrap d-f j-c-s-b a-i-f-e">
                <div class="question-container question-1-7 d-f j-c-s-b">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
    										...
    										<td>
    										   <input type="text" name="monthly_pay" placeholder="Value" value="<?php if(count($maindata_ques_1) && count($maindata_ques_1) > 1){ echo $maindata_ques_1[1]->meta_value; } ?>" class="monthly_pay_ques_one">
    										</td>
                                        </tr>
                                        <tr>
                                            <td>1.4 Free_Aprt</td>
                    ...
                    if(count($maindata_ques_2) > 0){

                    if($maindata_ques_2[2]->meta_value != ""){
                    ...
                    if($maindata_ques_2[3]->meta_value != ""){
                        ...
                        <div class="question-container question-2 ">
                            <form method="post" id="formQuestionTwo">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
        										   <input type="text" id="property-value1" class="form-control property_one common_extra_cls" name="property_value[]" placeholder="2,000,000" value="<?php if(isset($property_value)){ echo $property_value[0];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="property-value1" class="form-control property_two common_extra_cls" name="property_value[]" placeholder="2,000,000" value="<?php if(isset($property_value)){ echo $property_value[1];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="property-value1" class="form-control property_three common_extra_cls" name="property_value[]" placeholder="2,000,000" value="<?php if(isset($property_value)){ echo $property_value[2];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                            </tr>
        									<tr>
                                                <td>2.3 Morg_Left</td>
                                                <td>
        										  <input type="text" id="monthly-income1" class="form-control monthly_one common_extra_cls" name="monthly_income[]" placeholder="2,000,000" value="<?php if(isset($monthly_income)){ echo $monthly_income[0];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										<input type="text" id="monthly-income1" class="form-control monthly_two common_extra_cls" name="monthly_income[]" placeholder="2,000,000" value="<?php if(isset($monthly_income)){ echo $monthly_income[1];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										<input type="text" id="monthly-income1" class="form-control monthly_three common_extra_cls" name="monthly_income[]" placeholder="2,000,000" value="<?php if(isset($monthly_income)){ echo $monthly_income[2];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                            </tr>
        									<tr>
                                                ...
                                                <td>
                                                    @php
                                                    if(isset($monthly_income) && isset($property_value) ){
                                                    ...
                                                    @endphp
        										  <input type="text" placeholder="1k - 10m" class="form-control owner_one" value="@php echo$final1; @endphp" />
        										</td>
                                                <td>
        										@php
                                                    if(isset($monthly_income) && isset($property_value)){
                                                    ...
                                                    @endphp
                                                  <input type="text" placeholder="1k - 10m" class="form-control owner_two" value="@php echo$final1; @endphp" />
        										</td>
                                                <td>
        										@php
                                                    if(isset($monthly_income) && isset($property_value) ){
                                                    ...
                                                    @endphp
                                                  <input type="text" placeholder="1k - 10m" class="form-control owner_three" value="@php echo$final1; @endphp" />
        										</td>
                                            </tr>
        									<tr>
                                                <td>2.5 Monthly _Morg</td>
                                                <td>
        										  <input type="text" id="mortgage-balance1" class="form-control balance_one common_extra_cls" name="mortgage_balance[]" placeholder="1000,000" value="<?php if(count($mortgage_balance) > 0){ echo $mortgage_balance[0];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="mortgage-balance1" class="form-control balance_two common_extra_cls" name="mortgage_balance[]" placeholder="1000,000" value="<?php if(count($mortgage_balance) > 1){ echo $mortgage_balance[1];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="mortgage-balance1" class="form-control balance_three common_extra_cls" name="mortgage_balance[]" placeholder="1000,000" value="<?php if(count($mortgage_balance) > 2){ echo $mortgage_balance[2];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                            </tr>
        									<tr>
                                                <td>2.6 Monthly_Rental_Profit</td>
                                                <td>
        										  <input type="text" id="property-value-2" class="form-control prop_one common_extra_cls" name="property_val[]" placeholder="1,000,000" value="<?php if(count($property_value_2) > 0){ echo $property_value_2[0];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="property-value-2" class="form-control prop_two common_extra_cls" name="property_val[]" placeholder="1,000,000" value="<?php if(count($property_value_2) > 1){ echo $property_value_2[1];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                                <td>
        										  <input type="text" id="property-value-2" class="form-control prop_three common_extra_cls" name="property_val[]" placeholder="1,000,000" value="<?php if(count($property_value_2) > 2){ echo $property_value_2[2];  }else{ echo""; } ?>" onkeyup="this.value=addCommas(this.value);"/>
        										</td>
                                            </tr>
        									<tr>
                                                <td>2.7 Which_Bank</td>
                                                <td>
            										 <select name="bank[]" class="aMorTable common_extra_cls_sel">
                                ...
                                <div class="table-heading d-f tBoxDesign">
        						    <input type="radio" id="boxOne" name="que2" value="Yes" <?php if(count($maindata_ques_2)){ if($maindata_ques_2[0]->meta_value == "Yes"){ echo "checked=checked"; } else{ } } ?> >
                                    <label for="boxOne"  class="success-div d-f f-d-c j-c-c">
                                        <span>2 Has_Aprt</span>
                                        <span>2A: No_Morg, 2B: With_Morg</span>
                                    </label>
        							<input type="radio" id="boxTwo" name="que2" value="No" <?php if(count($maindata_ques_2)){ if($maindata_ques_2[0]->meta_value == "No"){ echo "checked=checked"; } else{ } } ?> >
                        ...
                        <ul>
                            <li>
                                <div class="form-group d-f f-d-c a-i-c">
                                    ...
                                    <label>Max (2.4)</label>
                                    <input type="text" class="form-control" id="max_owner_value" name="max_owner_value" value="" />
                            ...
                            <li>
                                <div class="form-group d-f f-d-c a-i-c">
                                    ...
                                    <input type="text" class="form-control" id="total_monthly_pay" name="total_monthly_pay"  value="" />
                                    <i class="fa fa-arrow-right"></i>
                                    <i class="fa fa-arrow-right"></i>
                                </div>
                            </li>
