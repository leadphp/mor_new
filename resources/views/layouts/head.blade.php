...
<link type="text/css" href="{{ URL::asset('css/jquery.ui.slider-rtl.css') }}" rel="stylesheet">

<script src="{{ URL::asset('js/jquery.min.js') }}"></script>
<!-- sweet-alert -->
<link href="{{ URL::asset('css/sweet-alert.css') }}" rel="stylesheet">
