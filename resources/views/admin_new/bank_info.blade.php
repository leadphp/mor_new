                                    ...
                                    <div class="all-docs">
                                        <div class="form-group-container">
                                            <div class="form-group">
                                                <label>(One PDF file (All Docs</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group datepicker-container input-frontend">
                                                        <input type="text" class="datepicker1" id="issue-date" name="issue-date" placeholder="DD.MM.YYYY" />
                                                        <img src="images/icon-calendar-green.png" alt="" /> </div>
                                                </td>
                                                <td>
                                                    <div class="form-group datepicker-container input-frontend">
                                                        <input type="text" class="datepicker2" id="issue-date-2" name="issue-date-2" placeholder="DD.MM.YYYY" />
                                                        <img src="images/icon-calendar-green.png" alt="" /> </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group datepicker-container input-frontend">
                                                        <input type="text" class="datepicker3" id="birth-date" name="birth-date" placeholder="DD.MM.YYYY" />
                                                        <img src="images/icon-calendar-green.png" alt="" /> </div>
                                                </td>
                                                <td>
                                                    <div class="form-group datepicker-container input-frontend">
                                                        <input type="text" class="datepicker4" id="birth-date-2" name="birth-date-2" placeholder="DD.MM.YYYY" />
                                                        <img src="images/icon-calendar-green.png" alt="" /> </div>
                                                </td>
                                            </tr>
                                            <tr>
