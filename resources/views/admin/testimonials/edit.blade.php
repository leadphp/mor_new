                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Title :</label>
                      <div class="col-sm-12">
                        <input type="text" class="span form-control" placeholder="Enter Testimonial Title" name="title" value="{{ $testimonial->title }}"> @if($errors->has('title'))
                  ...
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Tag :</label>
                      <div class="col-sm-12">
                        <input type="text" class="span form-control" placeholder="Enter Testimonial Tag" name="tag" value="{{ $testimonial->tag }}"> @if($errors->has('tag'))
