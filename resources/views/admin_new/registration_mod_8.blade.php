                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <div class="inputYesNo">
                                             ...
                                             <label for="fieldThree">
                                                @foreach($maindata_ques_1 as $ques1)
                                                <?php 
                                                if($ques1->meta_value == "rental_aprt" && $ques1->meta_key == "ques1"){
                                                    ?>
                                                     <div class="selectedYes">Yes</div>
                                                    <?php 
                                                }
                                        ...
                                        <td>
                                            <?php  
                                                if($ques1->meta_key == "ques1Option"){
                                                   ?>
                                                   <input type="text" placeholder="Value" value="{{$ques1->meta_value}}">
                                                   <?php
                                                }
                                                else{
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($maindata_ques_2 as $ques2)
                                            <?php 
                                                if($ques2->meta_key == "property_value"){
                                                    $q2 = $ques2->meta_value;
                                                    $dataa = json_decode($q2);
                                                    if(isset($dataa[0])){
                                                        ?>
                                                        <input type="" placeholder="1k - 10m" value="{{$dataa[0]}}" />
                                                        <?php
                                                    }
                                                    else{
                                                        ?>
                                                        <input type="" placeholder="1k - 10m" value="" />
                                                        <?php
                                                    }
                                                    ?>
                                        ...
                                        <td>
                                            <?php  if(isset($dataa[1])){?>
                                                <input type="" placeholder="1k - 10m" value="{{$dataa[1]}}" />
                                                <?php
                                            } 
                                            else{ ?>
                                        ...
                                        <td>
                                            <?php  if(isset($dataa[2])){?>
                                                <input type="" placeholder="1k - 10m" value="{{$dataa[2]}}" />
                                                <?php
                                            } 
                                            else{ ?>
                                            <input type="" placeholder="1k - 10m"  />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          @foreach($maindata_ques_2 as $ques2)
                                            <?php 
                                                if($ques2->meta_key == "mortgage_balance"){
                                                    $aa = $ques2->meta_value;
                                                    $data = json_decode($aa);
                                                    if(isset($data[0])){
                                                        ?>
                                                         <input type="" placeholder="1k - 10m" value="{{$data[0]}}" />
                                                        <?php
                                                    }
                                                    else{?>
                                                        <input type="" placeholder="1k - 10m" />
                                         ...
                                         <td>
                                            <?php  if(isset($data[1])){
                                                ...
                                                ?>
                                                <input type="" placeholder="1k - 10m" value="{{$data[1]}}" />
                                                <?php
                                            } 
                                            else{ ?>
                                            <input type="" placeholder="1k - 10m"  />
                                    ...
                                    <tr>
                                        ...
                                        @foreach($maindata_ques_2 as $ques2)
                                        <?php 
                                            if($ques2->meta_key == "property_1"){
                                                $a = $ques2->meta_value;
                                                $datas= json_decode($a);
                                                if($datas[0] == "Apartment_without_mortgage"){
                                                    if(isset($data[0]) && isset($dataa[0])){
                                                        ?>
                                                        <td>
                                                           <input type="" placeholder="1k - 10m" value="work" />
                                                        </td>
                                                        <?php
                                                    }
                                                    if(isset($data[1])){
                                                    ...
                                                    if(isset($data[2])){
                                                        ?>
                                                        <td>
                                                           <input type="" placeholder="1k - 10m" value="{{$data[2]}}" />
                                                        </td>
                                                        <?php
                                                    }
                                                }
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <select>
                                            @foreach($maindata_ques_3 as $ques3)

                                          <option <?php if($ques3->meta_key == "gender" && $ques3->meta_value == "Male"){
                                            echo "selected";
                                          }?>>Male</option>
                                          <option <?php if($ques3->meta_key == "gender" && $ques3->meta_value == "Female"){
                                            echo "selected";
                                          }?>>Female</option>
                                          @endforeach
                                        </select>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($maindata_ques_4 as $ques4)
                                        <?php 
                                            if($ques4->meta_key == "family_income" ){
                                                ?>
                                                <td><input type="text" placeholder="value" value="<?php echo $ques4->meta_value; ?>" ></td>
                                                <?php
                                            }
                                        ?>
                                    ...
                                    <tr>
                                        ...
                                        <select id="q51">
                                         @foreach($maindata_ques_5 as $ques5)

                                          <option value="yes" <?php if($ques5->meta_key == "Stable_status" && $ques5->meta_value == "yes"){
                                            echo "selected";
                                          }?>>Yes</option>
                                          <option value="no" <?php if($ques5->meta_key == "Stable_status" && $ques5->meta_value == "no"){
                                            echo "selected";
                                          }?>>No</option>
                                          @endforeach
                                        </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <input type="taxt" placeholder="value" id="optval">
                                        </td>
                ...
                <div class="question-container question-8-11 d-f">
                    <div class="question-8-11-left">
                        ...
                        <div class="mortgage-cause d-f j-c-s-b">
                            ...
                            @foreach($maindata_ques_8 as $ques8)
                            <div class="m-c-1">
                                <ul>
                                    <li>
                                        ...
                                        <span>
                                         <div class="inputYesNo">
                                             <input type="radio" <?php if($ques8->meta_key == "why_mortgage" && $ques8->meta_value == "new_aprt"){echo "checked";} ?> id="fieldFive" name="fieldSelected2">
                                             <label for="fieldFive">
                                    ...
                                    <li>
                                        ...
                                        <span>
                                         <div class="inputYesNo">
                                             <input type="radio" <?php if($ques8->meta_key == "why_mortgage" && $ques8->meta_value == "second_hand_aprt"){echo "checked";} ?> id="fieldSix" name="fieldSelected2">
                                             <label for="fieldSix">
                                               <div class="selectedNo">X</div>
                                               <div class="selectedYes">Yes</div>
                                             </label>
                                    ...
                                    <li>
                                        ...
                                        <span>
                                         <div class="inputYesNo">
                                             <input type="radio"  <?php if($ques8->meta_key == "why_mortgage" && $ques8->meta_value == "construction"){echo "checked";} ?>  id="fieldSeven" name="fieldSelected2">
                            ...
                            <div class="m-c-2">
                                <ul>
                                    <li>
                                        ...
                                        <span>
                                         <div class="inputYesNo">
                                             <input type="radio" <?php if($ques8->meta_key == "why_mortgage" && $ques8->meta_value == "mistaken_program"){echo "checked";} ?> id="fieldEight" name="fieldSelected2">
                            ...
                            <div class="m-c-3">
                                <ul>
                                    <li>
                                        ...
                                        <span>
                                         <div class="inputYesNo">
                                             <input type="radio" <?php if($ques8->meta_key == "why_mortgage" && $ques8->meta_value == "any_cause"){echo "checked";} ?> id="fieldNine" name="fieldSelected2">
                                             <label for="fieldNine">
                                               <div class="selectedNo">X</div>
                                               <div class="selectedYes">Yes</div>
                                             </label>
                            ...
                            <div class="question-9-11 d-f f-d-c">
                                <div class="m-c-4 no-margin">
                                   ...
                                   @foreach($maindata_ques_9 as $ques9)
                                   <ul>
                                        <li>
                                            <span>9.1 Investor</span>
                                            <span>
                                              <div class="inputYesNo">
                                                <input type="radio" id="fieldTen" 
                                                <?php if($ques9->meta_key == "status_of_mortgage" && $ques9->meta_value == "investor"){echo "checked";} ?>  name="fieldSelected5">
                                                 <label for="fieldTen">
                                                   <div class="selectedNo">X</div>
                                                   <div class="selectedYes">Yes</div>
                                                 </label>
                                        ...
                                        <li>
                                            ...
                                            <span>
                                              <div class="inputYesNo">
                                                 <input type="radio" 
                                                <?php if($ques9->meta_key == "status_of_mortgage" && $ques9->meta_value == "asset_improver"){echo "checked";} ?> id="fieldEleven" name="fieldSelected5">
                                        ...
                                        <li>
                                            ...
                                            <span>
                                              <div class="inputYesNo">
                                                <input type="radio" id="fieldTwelve" 
                                                <?php if($ques9->meta_key == "status_of_mortgage" && $ques9->meta_value == "first_aprt"){echo "checked";} ?>  name="fieldSelected5">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="a-month-return">
                                                        <div class="col-2">
                                                         ...
                                                         @foreach($maindata_ques_10 as $ques10) 
                                                        <?php 
                                                        if($ques10->meta_key == "Grace" ){
                                                        ?>
                                                        <div class="col-2">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="month" name="month" value="<?php echo $ques10->meta_value ?>" /> </div>
                                                        </div>
                                                        <?php } ?>
                                                        @endforeach
                                                    </div>
                                ...
                                <div class="offer-tabs property-evaluation">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active clearfix" id="property-evaluation">
                                            <div class="row">
                                                  @foreach($maindata_ques_11 as $ques11) 
                                                <div class="col-md-4">
                                                    <div class="tab-inner-heading">
                                                        <h2>Q11A - </h2>
                                                    ...
                                                    <div class="a-month-return d-f a-i-c">
                                                        ...
                                                        <div class="col-2">
                                                            <?php 
                                                        if($ques11->meta_key == "property_value" ){
                                                        ?>
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id="property-value" name="property-value" value="<?php echo $ques11->meta_value ?>" /> </div>
                                                                <?php  } ?>
                                                        </div>
                                                    </div>
                                                    <div class="a-month-return d-f a-i-c">
                                                        ...
                                                        <div class="col-2">
                                                            <div class="form-group">
                                                                <?php if($ques11->meta_key == "property_value" ){
                                                        ?>
                                                                <input type="text" class="form-control" id="self-funding" name="self-funding" value="<?php echo $ques11->meta_value?>"/> <?php } ?></div>
